...
const stages = [
  ...
  { value: 'team', label: '团队回应', number: '02', title: '团队方案如何回应这些条件。', text: '保留原项目的定位、功能与空间策略，但明确标注为团队方案。之后会用一张总览图和一条主要轴线，避免把整套 PPT 缩成无法阅读的图片。', note: '待填素材：原项目总图 · 功能框架 · 团队方案摘要' },
  { value: 'personal', label: '本人交付', number: '03', title: '我把方案如何表达清楚。', text: '选取一段主要轴线或关键节点，展示现场理解、整体与节点建模、汇报图细化之间的关系。每一张图都对应一项明确的个人工作。', note: '待填素材：模型过程 · 节点对比 · 汇报图件' },
